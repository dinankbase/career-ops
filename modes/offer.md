...
**For creative/marketing roles, also use SOAR format:**
- **S**ituation, **O**bjective (not Task - shows creative vision), **A**ction, **R**esult
- Reference `interview-prep/reframe-bank.md` for career transition reframes
- Frame sales experience using creative vocabulary (see reframe bank)

Also include:
- 1 recommended case study (which project to present and how)
- Red-flag questions and how to answer them (e.g., "Why the career change?", "No agency experience?")
- **Spec work recommendation**: what interview collateral to bring (Creative Audit, 90-Day Plan, spec ads)
- **Soft close question**: "What does your best [role title] do differently? Any concerns about my fit?"
- **Tip**: Run `/career-ops interview [company]` for full interview prep with Creative Audit, Q&A by round, and mock simulation
