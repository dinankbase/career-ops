...
Les autres modes (`scan`, `batch`, `pdf`, `tracker`, `auto-pipeline`, `deep`, `contact`, `offers`, `project`, `training`) restent en EN/ES. Leur contenu est surtout du tooling, des chemins et des commandes -- il doit rester independant de la langue.
...
- Noms d'outils (skill `/browser`, `WebSearch`, `WebFetch`, `Read`, `Write`, `Edit`, `Bash`)
