...
2. **Pour chaque URL en attente** :
   ...
   b. **Extraire l'offre** avec le skill `/browser` -> WebFetch -> WebSearch
...
1. **/browser skill (prefere) :** Naviguer et lire la page. Fonctionne avec toutes les SPAs.
2. **WebFetch (fallback) :** Pour les pages statiques ou quand le skill /browser n'est pas disponible.
...
- **Welcome to the Jungle / Indeed FR / APEC** : Portails francophones courants. Le skill /browser gere bien les cookie banners
