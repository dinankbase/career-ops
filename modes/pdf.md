...
14. Execute: `python generate-pdf.py /tmp/cv-candidate-{company}.html output/cv-candidate-{company}-{YYYY-MM-DD}.pdf --format={letter|a4}`
...
Update tracker if the posting is already registered: change PDF from ❌ to ✅.
