...
2. **Für jede offene URL**:
   ...
   b. **Stellenanzeige extrahieren** mit dem `/browser` Skill → WebFetch → WebSearch
...
1. **/browser Skill (bevorzugt):** Webseite navigieren und Inhalt lesen. Funktioniert mit allen SPAs.
2. **WebFetch (Fallback):** Für statische Seiten oder wenn der /browser Skill nicht verfügbar ist.
...
- **StepStone / XING / kununu**: Häufig deutscher Markt, oft Cookie-Banner. Der /browser Skill kann scrollen, um den Anzeigentext zu erfassen
