...
| generate-pdf.py | `generate-pdf.py` | For PDF |
...
Classify the offer into one of the 6 archetypes. If it is a hybrid, indicate the 2 closest ones.
...
| **AI Transformation Lead** | Change management, adoption, org enablement | Someone who leads AI change across an organization |
...
- Header: Space Grotesk 24px bold + cyan-to-purple gradient 2px + contact info
