...
Available commands:
  ...
  /career-ops interview -> Interview prep: audit + plan + Q&A + mock

Inbox: add URLs to data/pipeline.md -> /career-ops pipeline
Drop materials in inbox/ for review.
...
Applies to: `interview`

### Modes delegated to subagent:
For `scan`, `apply` (with /browser skill), and `pipeline` (3+ URLs): launch as Agent with the content of `_shared.md` + `modes/{mode}.md` injected into the subagent prompt.
